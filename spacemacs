...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   ;; `/usr/local/bin/fish'.
   ;; (default nil)
   dotspacemacs-import-env-vars-shell-file-name "/usr/local/bin/zsh"
...
(defun dotspacemacs/user-init ()
  ...
  ;; OS specifics
  (cond ((eq system-type 'darwin)
         (setq dotspacemacs-configuration-layers (append dotspacemacs-configuration-layers '(osx))))
        ((eq system-type 'gnu/linux)
...
(defun dotspacemacs/user-config ()
  ...
  ;; pyenv
  (require 'pyvenv)
  (setq-default python-auto-set-local-pyenv-version 'on-visit)
  (setq-default python-auto-set-local-pyvenv-virtualenv 'on-visit)
